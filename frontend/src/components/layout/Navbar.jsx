        ...
        <div className="hidden md:flex items-center gap-1">
          {links.map(({ to, label, icon, end }) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-semibold transition-all ${isActive
            ...
            <div className="grid gap-2 p-3">
              {links.map(({ to, label, icon, end }) => (
                <NavLink
                  ...
                  onClick={() => setIsMobileMenuOpen(false)}
                  className={({ isActive }) =>
                    `flex items-center justify-between rounded-2xl px-4 py-3 text-sm font-black transition-all ${isActive
